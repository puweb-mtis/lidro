...
const mainSwiper = new SwiperInit('.main-visual-swiper', {
    ...
    activeInSlideNames: [`.main-visual__blur`, `.main-visual-sub-title`, `[data-letter-animation="main-visual"]`, `.main-visual__more-link`],
    inactiveInSlideNames: [`.main-visual__blur`, `.main-visual-sub-title`, `[data-letter-animation="main-visual"]`, `.main-visual__more-link`],
    video: 'video',
    swiperOptions: {
        keyboard: {
            enabled: true,
